...
(function ($) {
    ...
    function _19(_1a) {
        ...
        _1b.window.resizable({
            disabled: _1b.options.resizable == false, onStartResize: function (e) {
                if (_1b.pmask) {
                    _1b.pmask.remove();
                }
                ...
                _1b.pmask.css({
                    ...
                    left: e.data.left,
                    top: e.data.top,
                    width: _1b.window._outerWidth(),
                    height: _1b.window._outerHeight()
                });
                if (_1b.proxy) {
                    _1b.proxy.remove();
                }
    ...
    $.fn.window.methods = {
        options: function (jq) {
            ...
            return $.extend(_21, {
                closed: _20.closed,
                collapsed: _20.collapsed,
                minimized: _20.minimized,
                maximized: _20.maximized
            });
        }, window: function (jq) {
    ...
    $.fn.window.parseOptions = function (_26) {
        return $.extend({}, $.fn.panel.parseOptions(_26), $.parser.parseOptions(_26, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
