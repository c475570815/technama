...
(function ($) {
    ...
    function _f(_10, _11) {
        ...
        _17.css({
            left: (_13.iconAlign == "left" ? (_13.buttonAlign == "left" ? btn._outerWidth() : 0) : ""),
            right: (_13.iconAlign == "right" ? (_13.buttonAlign == "right" ? btn._outerWidth() : 0) : "")
        });
        _18.css({width: _13.iconWidth + "px", height: tb.height() + "px"});
        _16.css({
            paddingLeft: (_10.style.paddingLeft || ""),
            paddingRight: (_10.style.paddingRight || ""),
            marginLeft: _19("left"),
            marginRight: _19("right")
        });
        if (_13.multiline) {
    ...
    function _a(_1b) {
        ...
        _1d.validatebox($.extend({}, _1c, {
            deltaX: $(_1b).textbox("getTipX"), onBeforeValidate: function () {
    ...
    $.fn.textbox = function (_37, _38) {
        ...
        return this.each(function () {
            ...
            if (_3b) {
                ...
                _3b = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _37),
                    textbox: _1(this)
                });
    ...
    $.fn.textbox.parseOptions = function (_52) {
        var t = $(_52);
        return $.extend({}, $.fn.validatebox.parseOptions(_52), $.parser.parseOptions(_52, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", {
            multiline: "boolean",
            iconWidth: "number"
