...
(function ($) {
    ...
    $.fn.slider = function (_40, _41) {
        ...
        return this.each(function () {
            ...
            if (_42) {
                ...
                _42 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _40),
                    slider: _1(this)
                });
    ...
    $.fn.slider.parseOptions = function (_49) {
        var t = $(_49);
        return $.extend({}, $.parser.parseOptions(_49, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_4a) {
            return _4a;
        },
        converter: {
            toPosition: function (_4b, _4c) {
