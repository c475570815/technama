...
(function ($) {
    ...
    $.fn.combobox = function (_4f, _50) {
        ...
        return this.each(function () {
            ...
            if (_52) {
                ...
                _52 = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _4f),
                    data: []
                });
            }
            _42(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _54.width,
                height: _54.height,
                originalValue: _54.originalValue,
                disabled: _54.disabled,
                readonly: _54.readonly
            });
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        loader: function (_71, _72, _73) {
            ...
            $.ajax({
                type: _74.method, url: _74.url, data: _71, dataType: "json", success: function (_75) {
                    _72(_75);
                }, error: function () {
