...
(function ($) {
    ...
    function _12(_14, _15) {
        ...
        _15.find(".menu-item").each(function () {
            ...
            $(this).find(".menu-text").css({
                height: (_16.itemHeight - 2) + "px",
                lineHeight: (_16.itemHeight - 2) + "px"
            });
        });
    ...
    function _28(_29, _2a) {
        ...
        _2d.show(0, function () {
            ...
            _2d[0].shadow.css({
                display: (_2d.hasClass("menu-inline") ? "none" : "block"),
                zIndex: $.fn.menu.defaults.zIndex++,
                left: _2d.css("left"),
                top: _2d.css("top"),
                width: _2d.outerWidth(),
                height: _2d.outerHeight()
            });
    ...
    $.fn.menu.parseOptions = function (_61) {
        return $.extend({}, $.parser.parseOptions(_61, [{
            minWidth: "number",
            itemHeight: "number",
            duration: "number",
