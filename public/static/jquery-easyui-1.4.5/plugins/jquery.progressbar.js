...
(function ($) {
    ...
    function _4(_5, _6) {
        ...
        _8.find("div.progressbar-text,div.progressbar-value").css({
            height: _8.height() + "px",
    ...
    $.fn.progressbar = function (_9, _a) {
        ...
        return this.each(function () {
            ...
            if (_c) {
                ...
                _c = $.data(this, "progressbar", {
                    options: $.extend({}, $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _9),
                    bar: _1(this)
                });
            }
